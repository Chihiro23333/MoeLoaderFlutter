...
class RequestManager {
  ...
  Future<String> dioRequestNoRedirect(String url, {Map<String, String>? headers}) async {
    var response = await _dioHttp.redirectNotGet(url, headers: headers);
    var result = response.toString();
    return result;
  }

  Future<String> dioRequestRedirectUrl(String url,
      {Map<String, String>? headers}) async {
    Response response = await _dioHttp.redirectYestGet(url, headers: headers);
  ...
  Future<bool> download(String url, String savePath,
      {ProgressCallback? onReceiveProgress,
      CancelToken? cancelToken,
      Map<String, String>? headers}) async {
    try {
      await _dioHttp.download(url, savePath,
